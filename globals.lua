...
function Game:set_globals()
    ...
    self.COLLABS = {
        ...
        options = {
            Spades = {'default', 'collab_TW', 'collab_CYP', 'collab_SK', 'collab_DS', 'collab_AC', 'collab_STP'},
            Hearts = {'default', 'collab_AU', 'collab_TBoI', 'collab_CL', 'collab_D2', 'collab_CR', 'collab_BUG'},
            Clubs = {'default', 'collab_VS', 'collab_STS', 'collab_PC', 'collab_WF', 'collab_FO', 'collab_DBD'},
            Diamonds = {'default', 'collab_DTD', 'collab_SV', 'collab_EG', 'collab_XR', 'collab_C7', 'collab_R'}
        }
    }
    ...
    self.C = {
        ...
        RARITY = {HEX('009dff'), -- HEX("708b91"),
        HEX("4BC292"), HEX('fe5f55'), HEX("b26cbb")},
        BLIND = {
            Small = HEX("50846e"),
            Big = HEX("50846e"),
            Boss = HEX("b44430"),
        ...
        HAND_LEVELS = {HEX("efefef"), HEX("95acff"), HEX("65efaf"), HEX('fae37e'), HEX('ffc052'), HEX('f87d75'),
                       HEX('caa0ef')},
        BACKGROUND = {
            L = {1, 1, 0, 1},
            D = HEX("374244"),
    ...
    self.handlist = {"Flush Five", "Flush House", "Five of a Kind", "Straight Flush", "Four of a Kind", "Full House",
